...
<body onload="show_hide()">
      ...
      <div class="row">
        <div class="col-md-12 bg-dark bottom-radius">
          <ul class="nav nav-pills bg-dark w-100">
            ...
            <li class="nav-item bg-dark">
              <a class="nav-link text-white" href="ExaminerAssignController">Examiner</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 py-3 my-2 bordergray" style="border-radius: 10px;">
          <h3 class=""><i class="fa fa-user fa-bullhorn"></i>announcement</h3>
          <br>
  ...
  <div class="my-4">
    <div class="container">
      <div class="row">
        <div class="col-md-4 py-3 bordergray text-center" style="border-radius: 10px;">
          <h3 class=""><i class="fa fa-fw fa-list-alt "></i>proposal submission</h3>
          <br>
          <div class="text-center text-white">
            <a id="c_button" class="btn btn-primary pi-draggable text-white w50" href="" draggable="true">Proposal Submission </a>
          </div>
        </div>
        <div class="col-md-4 py-3 bordergray text-center" style="border-radius: 10px;">
          ...
          <br>
          <div class="text-center text-white ">
            <a id="c_button" class="btn btn-primary pi-draggable text-white w50" href="" draggable="true">Evaluation </a>
          </div>
        </div>
        <div class="col-md-4 py-3 bordergray text-center" style="border-radius: 10px;">
          <h3 class=""><i class="fa fa-fw fa-bar-chart"></i>examiner setup</h3>
          <br>
          <div class="text-center text-white">
            <a id="c_button" class="btn btn-primary pi-draggable text-white w50" href="" draggable="true">Examiner Setup </a>
          </div>
        </div>  
      </div>
    </div>
