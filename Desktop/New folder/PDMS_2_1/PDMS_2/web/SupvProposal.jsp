...
<head>
  ...
  <link rel="stylesheet" href="css/jquery.dataTables.min.css" type="text/css"></style>
      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th class="text-center top-right-radius">Approval</th>
          </tr>
        </thead> 
        <tbody>
            <% 
          ...
          <tr>
            ...
            <td>
              <form name="form1" id="form1" method="POST" action="ProposalApprovalController">
                <input type="hidden" name="submit_id" value="<%= session.getAttribute("std_id_"+i)%>">
                <input type="hidden" name="i" value="<%= i%>">
                <div class="text-center"> 
                  <select name="approval" id="approval" class="r5" onchange="this.form.submit(); document.myForm.myMenu[document.myForm.myMenu.selectedIndex].value;">
  ...
  <div class="container">
    <div class="row">
        <div onclick="show_hide('ListProposal')" id="h3" class="col-md-12 py-3 my-2 bottom-radius top-right-radius top-left-radius bordergray">
            <h3>View List of Proposal Approval</h3>
        </div>
    </div>
  </div>        
              ...
              <tr>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><%= session.getAttribute("std_name_"+i)%></td>
                    <td>
                         <form class="login-form" action="ProposalDownloadController" method="post" id="Download" name="Download">
                            <input type="hidden" name="submit_id" value="<%= session.getAttribute("std_id_"+i)%>">                      
                            <input type="submit" value="<%= session.getAttribute("prop_title_"+i)%>">
                        </form>
                    <td class="text-center"><%= session.getAttribute("prop_approval_"+i)%></td>
                    <%   
                    }
                    %>
                  </tr>
